...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Easy Blog Bootstrap Admin Dashboard</title>
    <meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="coderxb, xuebing, person blog, person home">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        <div class="navbar-inner">
                ...
                <a class="brand" href="/admin/index.html"><span class="first">EasyBlog</span> <span class="second">Admin</span></a>
        </div>
    </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            <li><a href="/admin/index.html">主页</a></li>
            <li ><a href="/user/list.html">用户列表</a></li>
            <li ><a href="/user/create.html">新建用户</a></li>
