                ...
                <div class="well">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active in" id="home">
                            <form id="create-form" method="post" action="/user/save">
                            <label>用户名称：</label> 
                            <input name="name" type="text" value="${user.name }" class="input-xlarge" /> 
                            <label>英文名称：</label> 
                            <input name="enName" type="text" value="${user.enName }" class="input-xlarge" /> 
                            <label>电子邮箱：</label> 
                            <input name="email" type="text" value="${user.email }" class="input-xlarge" /> 
                            <label>性别：</label>
                            ...
                            <label>个人主页：</label> 
                            <input name="website" type="text" value="${user.website }" class="input-xlarge" /> 
                            <label>地址：</label> 
                            <textarea value="address" rows="3" class="input-xlarge">${user.position }</textarea>
                            </form>
