...
/**
 * 
 * use System.arraycopy method.<br>
 * <br>
 * copy a array From srcArray to the specified array's the specified position of
 * the target array. <br>
 * 
 * @author coderxb
 */
public class ResearchSystemArraycopy {
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(o2)); // [null, null, null, null,
												 // null]
		try {
